...
void woundWaitAlgorithm(vector<Process>& processes, int resource) {
...
int main() {
    ...
    woundWaitAlgorithm(processes, 0);  // Process 0 requests Resource 0
    woundWaitAlgorithm(processes, 1);  // Process 1 requests Resource 1
    woundWaitAlgorithm(processes, 0);  // Process 2 requests Resource 0
